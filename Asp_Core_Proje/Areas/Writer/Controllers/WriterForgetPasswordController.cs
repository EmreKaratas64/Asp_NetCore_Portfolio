...
namespace Asp_Core_Proje.Areas.Writer.Controllers
{
    ...
    public class WriterForgetPasswordController : Controller
    {
        private readonly UserManager<WriterUser> _userManager;

        public WriterForgetPasswordController(UserManager<WriterUser> userManager)
        {
        ...
        public async Task<IActionResult> Index(UserForgetPasswordViewModel u)
        {
            ...
            else
            {
                ...
                {
                    if (u.Password == u.ConfirmPassword && u.UserName.ToLower() != "admin" && v.IsValidPassword(u.Password))
                    {
