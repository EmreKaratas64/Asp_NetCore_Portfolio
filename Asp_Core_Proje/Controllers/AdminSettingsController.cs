...
namespace Asp_Core_Proje.Controllers
{
    ...
    public class AdminSettingsController : Controller
    {
        ...
        public AdminSettingsController(UserManager<WriterUser> userManager, SignInManager<WriterUser> signInManager)
        {
        ...
        public async Task<IActionResult> Index(UserEditViewModel u)
        {
            ...
            if (u.Password == u.PasswordConfirm && v.IsValidPassword(u.Password))
            {
                user.Name = u.Name;
